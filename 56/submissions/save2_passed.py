...
def create_parser():
    ...
    parser.add_argument('-w','--weight', metavar='WEIGHT', help='Your weight in kg', required=True)
    parser.add_argument('-l','--length', metavar='LENGTH', help='Your length in cm', required=True)
